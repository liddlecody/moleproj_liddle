#optimized hyperparateters and learning rate scheduling
import torch
...
scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=3, gamma=0.1)  #Decay LR by a factor of 0.1 every 3 epochs
...
torch.save(model_ft.state_dict(), "test_model.pth")
